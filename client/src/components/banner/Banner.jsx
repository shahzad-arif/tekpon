...
const Banner = () => {
    return (
        <section className="bg-gradient-to-br from-white to-blue-50 min-h-screen flex flex-col justify-center items-center px-4 py-2 text-center">
          ...
          {/* Heading */}
          <h1 className="text-6xl font-bold text-[#211F20]
           leading-tight">
            Find the right software{" "}
            <span className="text-[#4735AF]">deals</span> <br/>for your business
          </h1>
    
          {/* Subheading */}
          <p className="mt-4 text-3xl text-[#211F20]">
            Choose your software based on data summarized from{" "}
            <span className="text-[#4735AF] font-medium">230,807,871</span> <span className="font-medium">reviews</span>
          </p>
